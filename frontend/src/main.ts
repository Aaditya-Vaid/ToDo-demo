...
const summary = document.querySelector<HTMLDivElement>('#todo-summary');
...
function getTodoId(element: Element) {
  return Number(element.closest<HTMLLIElement>('.todo-list__item')?.dataset.id);
}
